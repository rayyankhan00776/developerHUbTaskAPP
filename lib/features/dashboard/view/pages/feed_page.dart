...
class _FeedPageBodyState extends State<_FeedPageBody> {
  ...
  void _showNotificationsDropdown(BuildContext context) {
    ...
    // Add scroll listener to auto-close dropdown
    _scrollController = PrimaryScrollController.of(context);
    _scrollController?.addListener(_hideNotificationsDropdown);
  }
  ...
  void _hideNotificationsDropdown() {
    ...
    if (_scrollController != null) {
      _scrollController?.removeListener(_hideNotificationsDropdown);
    }
  }
